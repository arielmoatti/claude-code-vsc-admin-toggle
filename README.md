...
**ולהריץ את VS Code כמנהל תמיד זה לא פתרון.** Windows יבקש אישור בכל פתיחה, וגרוע מזה: הוא חוסם גרירה מחלון רגיל לחלון שרץ כמנהל, אז אי אפשר יותר לגרור קבצים מהסייר לתוך VS Code או לצ'אט.
